...
const COACHING_TYPE_STYLES: Record<string, string> = {
  online: 'bg-[#ddf0df] text-[#2d5a31] border-[#3a7d44]/30',
  in_person: 'bg-[#f0faf0] text-[#2d5a31] border-[#3a7d44]/20',
  hybrid: 'bg-[#e8f4ea] text-[#2d5a31] border-[#3a7d44]/30',
};
      ...
      >
        ...
        <div className="px-6 pt-5 pb-4 border-b border-[#d8e0d8] flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 mt-2 flex-wrap">
              ...
              <span className="flex items-center gap-1 text-xs px-2 py-0.5 rounded-full bg-[#ddf0df] text-[#2d5a31] border border-[#3a7d44]/30 font-medium">
              ...
              {p.trialSessionAvailable && (
                <span className="flex items-center gap-1 text-xs px-2 py-0.5 rounded-full bg-amber-50 text-amber-700 border border-amber-300 font-medium">
          ...
          <button
            onClick={onClose}
            className="p-1.5 rounded-lg text-[#617061] hover:bg-[#f0f4f0] transition-colors flex-shrink-0"
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            {p.timezone && (
              <div className="flex items-center gap-2 bg-[#f6f8f5] rounded-xl p-3">
                <MapPin className="w-4 h-4 text-[#617061] flex-shrink-0" />
                <div>
              ...
              {(() => {
                ...
                return (
                  <div className="bg-[#f6f8f5] rounded-xl p-3 space-y-2">
                    ...
                    <div className="h-1.5 bg-[#d8e0d8] rounded-full overflow-hidden">
          ...
          {p.specialties && p.specialties.length > 0 && (
            <section>
              ...
              <div className="flex flex-wrap gap-1.5">
                {p.specialties.map((s) => (
                  <span key={s} className="px-2.5 py-1 text-xs rounded-full bg-[#ddf0df] text-[#2d5a31] border border-[#3a7d44]/20">
                    {s}
                  </span>
                ))}
              </div>
            ...
            <section>
              ...
              <div className="flex flex-wrap gap-1.5">
                ...
                {(p.trainingModalities ?? []).map((m) => (
                  <span key={m} className="px-2.5 py-1 text-xs rounded-full bg-[#f6f8f5] text-[#617061] border border-gray-200 border-[#d8e0d8]">
                    {m}
                  </span>
                ))}
              </div>
            ...
            <section>
              ...
              <div className="flex flex-wrap gap-1.5">
                {p.targetClientTypes.map((tc) => (
                  <span key={tc} className="px-2.5 py-1 text-xs rounded-full bg-[#f0faf0] text-[#2d5a31] border border-[#3a7d44]/20">
                    {tc}
                  </span>
                ))}
              </div>
            ...
            <section>
              ...
              <div className="flex flex-wrap gap-1.5">
                {p.languagesSpoken.map((lang) => (
                  <span key={lang} className="px-2.5 py-1 text-xs rounded-full bg-[#e8f4ea] text-[#2d5a31] border border-[#3a7d44]/20">
                    {lang}
                  </span>
                ))}
              </div>
              ...
              <div className="space-y-3">
                {packages.map((pkg) => {
                  ...
                  return (
                    <div
                      key={pkg.id}
                      className="bg-[#f6f8f5] rounded-xl p-4 border border-gray-200 border-[#d8e0d8] space-y-3"
                    >
                      ...
                      {isRequested ? (
                        ...
                        <button
                          ...
                          className="w-full flex items-center justify-center gap-2 py-2 rounded-lg bg-[#162318] text-white text-xs font-medium hover:opacity-90 transition-opacity disabled:opacity-60"
                        >
              ...
              <div className="space-y-2">
                {p.instagramHandle && (
                  <a
                    ...
                    className="flex items-center gap-2.5 text-sm text-[#617061] hover:underline"
                  >
        ...
        <div className="px-6 py-4 border-t border-[#d8e0d8] bg-white">
          {hasCoach ? (
            ...
            <div className="flex items-center justify-center gap-2 py-3 rounded-xl bg-[#ddf0df] text-[#2d5a31] border border-[#3a7d44]/20 text-sm font-medium">
            ...
            <button
              onClick={onRequest}
              className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-[#162318] text-white text-sm font-medium hover:opacity-90 transition-opacity"
            >
...
function CoachCard({
  ...
  return (
    <div className="bg-white rounded-2xl border border-[#d8e0d8] overflow-hidden flex flex-col hover:border-[#3a7d44] hover:shadow-lg transition-all">
      {/* Top accent bar */}
      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        {p.specialties && p.specialties.length > 0 && (
          <div className="flex flex-wrap gap-1.5 mb-4">
            {p.specialties.slice(0, 3).map((s) => (
              <span key={s} className="px-2 py-0.5 text-xs rounded-full bg-[#f6f8f5] text-[#617061] border border-gray-200 border-[#d8e0d8]">
                {s}
              </span>
            ))}
        ...
        <div className="grid grid-cols-2 gap-2 mb-4">
          ...
          {p.languagesSpoken && p.languagesSpoken.length > 0 && (
            <div className="flex items-center gap-1.5 text-xs text-[#617061]">
              <Languages className="w-3.5 h-3.5 text-[#617061] flex-shrink-0" />
        ...
        <div className="mt-auto space-y-2">
          {hasCoach ? (
            ...
            <div className="flex items-center justify-center gap-2 py-2.5 rounded-xl bg-[#ddf0df] text-[#2d5a31] border border-[#3a7d44]/20 text-sm font-medium">
              <CheckCircle2 className="w-4 h-4" />
              {t('requestSent')}
            </div>
          ) : (
            <button
              onClick={onRequest}
              className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl bg-[#162318] text-white text-sm font-medium hover:opacity-90 transition-opacity"
            >
              <Dumbbell className="w-4 h-4" />
              {t('requestConnect')}
            </button>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-1.5 py-2 rounded-xl border border-gray-200 border-[#d8e0d8] text-xs font-medium text-[#617061] hover:border-[#3a7d44] hover:text-[#3a7d44] transition-colors"
          >
            {t('viewProfile')}
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3 flex-wrap">
          ...
          <div className="relative flex-1 min-w-[200px] max-w-sm">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 text-sm rounded-xl border border-gray-200 border-[#d8e0d8] bg-white text-[#0f1f10] placeholder:text-[#617061] focus:outline-none focus:ring-2 focus:ring-blue-500/40"
            />
            {search && (
              <button onClick={() => setSearch('')} className="absolute right-2 top-1/2 -translate-y-1/2 text-[#617061] hover:text-gray-600">
          ...
          <button
            ...
            className={cn(
              ...
              trialOnly
                ...
                : 'border-gray-200 border-[#d8e0d8] text-[#617061] hover:border-amber-400 hover:text-amber-600'
            )}
          >
            <Flame className="w-3.5 h-3.5" />
            {t('trialFilter')}
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <button
              onClick={load}
              className="mt-4 px-4 py-2 text-xs font-semibold bg-[#162318] hover:bg-[#243d27] text-white rounded-lg transition-colors"
            >
              Retry
            </button>
          </div>
