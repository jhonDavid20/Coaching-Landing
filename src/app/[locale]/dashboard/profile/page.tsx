...
function Badge({ label, color }: { label: string; color: 'blue' | 'teal' | 'amber' }) {
  const styles = {
    blue: 'bg-[#ddf0df] text-[#2d5a31] border-[#3a7d44]/30',
    teal: 'bg-[#f0faf0] text-[#2d5a31] border-[#3a7d44]/20',
...
function WeightProgress({
  ...
  return (
    <div className="col-span-1 sm:col-span-2 bg-[#f6f8f5] rounded-xl p-4 border border-[#d8e0d8]">
      ...
      {/* Scale bar */}
      <div className="relative h-2 bg-[#d8e0d8] rounded-full overflow-hidden">
        <div
          className={cn(
      ...
      <div className="flex items-center gap-4 mt-2 text-xs">
        <span className="flex items-center gap-1.5 text-[#617061]">
          <span className="w-2 h-2 rounded-full bg-[#3a7d44] inline-block" />
          {labelCurrent}: <span className="text-[#0f1f10]">{weight} kg</span>
        </span>
        <span className="flex items-center gap-1.5 text-[#617061]">
          <span className="w-2 h-2 rounded-full bg-[#52a85e] inline-block" />
    ...
    <div className="max-w-3xl mx-auto space-y-4">
      ...
      <div className="bg-white rounded-2xl border border-[#d8e0d8] p-6 animate-pulse">
        <div className="flex items-center gap-5">
          <div className="w-20 h-20 rounded-full bg-[#e8f0e8] flex-shrink-0" />
          <div className="flex-1 space-y-2">
            <div className="h-5 bg-[#e8f0e8] rounded w-48" />
            <div className="h-4 bg-[#e8f0e8] rounded w-24" />
          </div>
          <div className="h-9 w-32 bg-[#e8f0e8] rounded-lg" />
        </div>
      </div>
      ...
      {[1, 2, 3].map((i) => (
        ...
        >
          <div className="flex items-center gap-4">
            <div className="w-10 h-10 rounded-xl bg-[#e8f0e8] flex-shrink-0" />
            <div className="flex-1 space-y-1.5">
              <div className="h-4 bg-[#e8f0e8] rounded w-36" />
              <div className="h-3 bg-[#e8f0e8] rounded w-52" />
            </div>
            <div className="w-4 h-4 rounded bg-[#e8f0e8]" />
          </div>
        </div>
      ))}
    </div>
      ...
      <div className="bg-white rounded-2xl border border-[#d8e0d8] overflow-hidden">
        ...
        <div className="px-6 py-6 flex flex-col sm:flex-row sm:items-center gap-4">
          ...
          {headerAvatar ? (
            ...
            <div className="w-20 h-20 rounded-full bg-[#162318] flex items-center justify-center flex-shrink-0 text-white text-2xl font-bold ring-2 ring-[#d8e0d8]">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 mt-1 flex-wrap">
              <span className="px-2.5 py-0.5 text-xs font-medium rounded-full bg-[#ddf0df] text-[#2d5a31] border border-[#3a7d44]/30 capitalize">
                {roleLabel}
              </span>
              {profile?.isEmailVerified && (
                <span className="px-2.5 py-0.5 text-xs font-medium rounded-full bg-[#ddf0df] text-[#2d5a31] border border-[#3a7d44]/30">
                  {t('verified')}
                </span>
              )}
            </div>
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-white rounded-lg bg-[#162318] hover:opacity-90 transition-opacity flex-shrink-0"
          >
        ...
        >
          <div className="space-y-6">
                  ...
                  {myCoach.specialties && myCoach.specialties.length > 0 && (
                    <div className="flex flex-wrap gap-1.5 mt-2">
                      {myCoach.specialties.slice(0, 4).map((s) => (
                        <span key={s} className="px-2 py-0.5 text-xs rounded-full bg-[#e8f4ea] text-[#2d5a31] border border-[#3a7d44]/20">
                          {s}
                        </span>
                      ))}
                    </div>
            ...
            <div className="border-t border-[#d8e0d8] pt-5">
              ...
              {myPlan?.package ? (
                <div className="bg-[#f0faf0] rounded-xl p-4 border border-[#3a7d44]/20">
